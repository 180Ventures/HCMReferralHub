...
export default function ModelChangePassword() {
  const { isOpen, showPassword, loading, closeModal, openModal, onSubmit, onToggleShowPassword } = useChangePassword();
  return (
    <React.Fragment>
      {loading && <LoadingPage />}
      <div
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-gray-900 font-Inter">
                    Change Password
                  </Dialog.Title>
                  <Formik
