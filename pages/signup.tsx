          ...
          <div className="relative w-full lg:w-[70%] h-full flex flex-col justify-between items-center bg-whiteColor p-5 2xl::p-10">
            <div className="flex justify-between w-full">
              <div className="flex flex-col sm:flex-row relative justify-center items-center text-xl md:text-2xl text-green font-normal">
                <div className="flex">
                  <p className="font-Poppins text-orangeLight font-normal">Health</p>
                  <p className="font-bold text-[25px] font-Poppins text-orangeLight">care</p>
                </div>
            ...
            <p className="max-w-[370px] text-xs font-normal">
              ...
              <span className="cursor-pointer text-orangeLight">Privacy Policy </span> and{' '}
              <span className="text-orangeLight cursor-pointer"> Terms of Service</span>.
            </p>
          </div>
        </div>
      </div>
