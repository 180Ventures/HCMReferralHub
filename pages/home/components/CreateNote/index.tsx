...
const CreateNote = ({ name, hideSave, disableArea, setName, onSaveNote }: IProps) => {
    ...
    <div className="flex flex-col p-4">
      ...
      {!hideSave && (
        <div className="flex justify-end mt-4">
          <button className={clsx('py-2 px-3 text-sm text-white rounded-lg bg-orangeLight')} onClick={onSaveNote}>
            Save
          </button>
        </div>
      )}
