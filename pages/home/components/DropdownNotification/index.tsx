    ...
    <li className="relative">
      ...
      >
        <div className="px-4.5 py-3">
          <h5 className="text-sm font-bold text-bodydark2 px-3 font-Inter">Notification</h5>
        </div>

        <ul className="flex h-auto flex-col overflow-y-auto">
          <li>
            <Link className="flex flex-col gap-2.5 border-t border-stroke px-4.5 py-5 px-3 font-Inter" href="#">
              <p className="text-xs font-Inter text-center">You have no notifications.</p>
              <p className="font-Inter text-center text-xs">Notifications will appear here when you get 'em.</p>
            </Link>
          </li>
          {notifications.map((value) => {
            return (
              <li>
                <Link className="flex flex-col gap-2.5 border-t border-stroke px-4.5 py-3 px-3 font-Inter" href="#">
