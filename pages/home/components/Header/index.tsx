...
const Header = ({ sidebarOpen, onChangeTextSearch, onSearchLeads, setSidebarOpen }: IProps) => {
      ...
      <div className="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="hidden sm:flex gap-2 items-center">
          <div className="relative w-[300px] px-4 py-5 h-8 rounded-lg bg-[#F9F9F9] flex items-center">
            <div onClick={() => onSearchLeads && onSearchLeads()} className="cursor-pointer">
              <SearchIcon />
            </div>
            <input
              type="search"
              onChange={(e) => onChangeTextSearch && onChangeTextSearch(e.target.value)}
