        ...
        <div className="w-full flex flex-row z-10">
          <div className="w-[30%] relative max-x-[500px] flex-col h-full items-center bg-white hidden lg:flex ">
            <div className="w-full h-full aspect-square relative">
              <Image alt="Logo" src="/images/banner-login.png" className="object-cover" fill priority />
            </div>
          ...
          <div className="relative w-full lg:w-[70%] h-full flex flex-col justify-center items-center bg-whiteColor p-5 2xl:p-10">
            <div className="flex justify-between w-full">
              <div className="flex flex-col sm:flex-row relative justify-center items-center text-xl md:text-2xl text-green font-normal">
                <div className="flex">
                  <p className="font-Poppins text-blueLight font-normal">Health</p>
                  <p className="font-bold text-[25px] font-Poppins text-blueLight">care</p>
                </div>
                <div className="relative">
                  <p className="font-semibold text-[25px] font-Poppins text-[#4B4039]">Marketplace</p>
              ...
              <p className="text-sm font-normal max-w-[40%] md:max-w-none">
                ...
                <span
                  ...
                  className="cursor-pointer text-blueLight text-sm font-semibold"
                >
                  Sign Up
                </span>
              </p>
            ...
            <p className="max-w-[370px] text-xs font-normal text-[#898989]">
              ...
              <span className="cursor-pointer text-[#4B4039]">Privacy Policy </span> and{' '}
              <span className="text-[#4B4039] cursor-pointer"> Terms of Service</span>.
            </p>
          </div>
        </div>
      </div>
